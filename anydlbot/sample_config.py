...
class Config(object):
    ...
    TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6458881761:AAHpFgx7kwsThRWHpwTimNOtSFc_6k-gKas")
    # The Telegram API things
    APP_ID = int(os.environ.get("APP_ID", 21165589))
    API_HASH = os.environ.get("API_HASH")
    # Get these values from my.telegram.org
    # Array to store users who are authorized to use the bot
    AUTH_USERS = set(int(x) for x in os.environ.get("AUTH_USERS", "2048030675").split())
